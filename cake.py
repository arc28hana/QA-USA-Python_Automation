class Cake:
    ...
    def mix_ingredients(self):
        print(f"Mixing {self.cake_flour} grams of flour, {self.cake_sugar} grams of sugar, "
              f"{self.cake_milk} ml of milk, and {self.cake_eggs} eggs.")
...
# Creating cake instances with flour, sugar, milk, eggs in order
cake_1 = Cake(200, 200, 240, 2)
cake_2 = Cake(200, 150, 220, 2)
cake_3 = Cake(170, 170, 200, 2)

# Accessing attributes and printing values
print(cake_1.cake_flour)  # Output: 200
print(cake_2.baking_time)  # Output: 30
